...
4. Ask concise blocking questions when the state variable, control set, HJB terms, boundary conditions, FOC logic, numerical method, or solver workflow are missing or ambiguous enough to change code generation.
