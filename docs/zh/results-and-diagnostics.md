...
请在 [库快速上手](./quickstart-library.md) 或 [快速开始](./getting-started.md) 之后阅读。如果你现在只想查对象成员，请改看 [API 参考](./api-reference.md)。如果你还需要看推导、齐次性降维和公式如何映射到代码，请先回到四个 BCW walkthrough。
